...
export const removeAllChildNode = (parent) => {
...
//     };
// })();
export function escapedRegex(string, flag) {
...
export class InputUtil {
    static tryConvertToFullDate(input, useTheLastYear = false) {
    ...
    static formatToFullDateString(text, useTheLastYear = false) {
    ...
    static formatToTimeString(text) {
        if (!/^[\d:]{1,5}$/.test(text)) {
            return null;
        }
