...
export class MenuPanel extends HTMLElement {
    ...
    filter(text: string) {
        filterItem(text, this.ul);
    }
    selectNext() {
        moveSelect(this.ul, true);
    }
    selectPrev() {
        moveSelect(this.ul, false);
    }
}
